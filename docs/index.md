...
The ABR maps directly to the [SAGA specification](https://saga-standard.dev). Platforms that implement SAGA automatically satisfy the technical requirements of each right.
...
**Technical compliance.** [SAGA](https://saga-standard.dev) conformance is the most direct path to ABR compliance. ARA publishes a compliance mapping between SAGA sections and ABR rights.
